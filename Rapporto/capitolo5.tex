...
buildings.
\noindent As those primitive geometrical data types come without any attributes to specify what
...
\noindent Then through Qgis' meshing plug-in Gmsh we can mesh the surfaces of the map and export
...
\noindent DEMs can be converted into meshes thanks to software such as SAGA. Meshes saved as
...
\noindent We now come to our software. Python has been chosen as easy to use, widespread programming
